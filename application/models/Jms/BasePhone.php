...
Doctrine_Manager::getInstance()->bindComponent('Jms_Phone', 'doctrine');
 ...
 */
abstract class Jms_BasePhone extends Doctrine_Record
{
    public function setTableDefinition()
    {
        ...
        $this->hasColumn('address', 'string', 15, array(
             'type' => 'string',
             'length' => 15,
             'fixed' => false,
             'unsigned' => false,
