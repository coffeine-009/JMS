...
///	***	Class.release	***	***	***	***	***	***	***	***	***	***	***	***	***	***	***	///
class Coffeine_Files_File
{
	///	***	Constants	***	///
	private $FILE_TYPE_DIR 	= 'DIR';
	private $FILE_TYPE_BACK = '..';
	private $FILE_TYPE_BEG 	= '.';
	private $FILE_TYPE_NONE = 'NONE';

	//private $FILE_TYPE_RESPONSE = '';
